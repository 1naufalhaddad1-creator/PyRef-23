...
const COLORS = {
  builtin:   { color: '#c9a961', dot: '#c9a961', bg: 'rgba(201,169,97,0.15)' },
  type:      { color: '#5c7a9e', dot: '#5c7a9e', bg: 'rgba(92,122,158,0.15)' },
  keyword:   { color: '#9c86b4', dot: '#9c86b4', bg: 'rgba(156,134,180,0.15)' },
  constant:  { color: '#c2903f', dot: '#c2903f', bg: 'rgba(194,144,63,0.15)' },
  exception: { color: '#b05a4a', dot: '#b05a4a', bg: 'rgba(176,90,74,0.15)' },
  warning:   { color: '#b06a3a', dot: '#b06a3a', bg: 'rgba(176,106,58,0.15)' },
  dunder:    { color: '#8a9a6f', dot: '#8a9a6f', bg: 'rgba(138,154,111,0.15)' },
};
