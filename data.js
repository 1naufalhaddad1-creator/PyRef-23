// Palet warna per kategori — dipakai oleh SECTIONS di bawah (sec.color.bg/.color/.dot)
// dan oleh app.js (COLORS[cmd.tag]) untuk mewarnai badge, tag, dan dot sidebar.
const COLORS = {
  builtin:   { color: '#c6f135', dot: '#c6f135', bg: 'rgba(198,241,53,0.15)' },
  type:      { color: '#6ea8e0', dot: '#6ea8e0', bg: 'rgba(110,168,224,0.15)' },
  keyword:   { color: '#a78bfa', dot: '#a78bfa', bg: 'rgba(167,139,250,0.15)' },
  constant:  { color: '#ffb84d', dot: '#ffb84d', bg: 'rgba(255,184,77,0.15)' },
  exception: { color: '#f05a5a', dot: '#f05a5a', bg: 'rgba(240,90,90,0.15)' },
  warning:   { color: '#ff6452', dot: '#ff6452', bg: 'rgba(255,100,82,0.15)' },
  dunder:    { color: '#4dd9c0', dot: '#4dd9c0', bg: 'rgba(77,217,192,0.15)' },
};
